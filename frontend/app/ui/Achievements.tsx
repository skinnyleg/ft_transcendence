...
const Achievements = ({doneAchievements, notDoneAchievements}: AchievementsDataProps)=> {
  return (
    <div className="bg-accents p-5 rounded-md lg:col-span-2 col-span-1 lg:col-start-4 lg:col-end-6 md:row-start-4 md:row-end-5 lg:row-start-1 lg:row-end-2 w-full h-[200px] xl:h-[370px] lg:h-[300px] shadow-md">
